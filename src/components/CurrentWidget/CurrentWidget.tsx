...
import styles from './CurrentWidget.module.scss';
import { WeatherData } from '../../services/weatherService';

export interface CurrentWidgetProps {
    weatherData: WeatherData;
}

export const CurrentWidget = ({ weatherData }: CurrentWidgetProps) => {
    return (
        <>
            <img
                draggable="false"
                src={`http://openweathermap.org/img/wn/${weatherData.current.weatherIcon}@4x.png`}
            />
            <div className={styles.city}>{weatherData.cityName}</div>
            <div className={styles.temp}>
                {weatherData.current.temp}
                <sup>&deg;C</sup>
            </div>
            <div className={styles.desc}>{weatherData.current.description}</div>
            <div className={styles.detailsRow}>
                <div title="Wind speed" className={classNames(styles.detail, styles.windSpeed)}>
                    {/* prettier-ignore */}
                ...
                <div title="Humidity" className={classNames(styles.detail, styles.windSpeed)}>
                    {/* prettier-ignore */}
                ...
                <div title="Clouds" className={classNames(styles.detail, styles.windSpeed)}>
                    {/* prettier-ignore */}
